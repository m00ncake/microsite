...
/* do not load tag manager in the local environment */
$conf['load_gtm'] = false;
...
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) && php_sapi_name() != 'cli') {
  ...
  if ($_ENV['PANTHEON_ENVIRONMENT'] === 'live') {
    /** Replace www.example.com with our registered domain name */
    $primary_domain = 'www.eztexting.com';
  }
  else {
...
if (isset($_ENV['PANTHEON_ENVIRONMENT'])) {
  ...
  $conf['composer_manager_vendor_dir'] = $_SERVER['HOME'] . '/code/sites/all/vendor';
